...
class exposure_tb extends StatefulWidget {
  const exposure_tb({super.key});

  @override
  State<exposure_tb> createState() => _exposure_tbState();
}

class _exposure_tbState extends State<exposure_tb> {
  // @override
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('lib/assets/images/exposure_tb.jpg' )
              // child: Image.asset('assets/mask.png'),
            ),
            Container(
                child: Text('Exposure Tuberculosis',
