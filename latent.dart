...
class latent_tb extends StatefulWidget {
  const latent_tb({super.key});

  @override
  State<latent_tb> createState() => _latent_tbState();
}

class _latent_tbState extends State<latent_tb> {
  // @override
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('lib/assets/images/latent_tb.jpg' )
              // child: Image.asset('assets/mask.png'),
            ),
            Container(
                child: Text('Tuberculosis Detector',
