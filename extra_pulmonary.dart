...
class extra_pulmonary_tb extends StatefulWidget {
  const extra_pulmonary_tb({super.key});

  @override
  State<extra_pulmonary_tb> createState() => _extra_pulmonary_tbState();
}

class _extra_pulmonary_tbState extends State<extra_pulmonary_tb> {
  // @override
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('lib/assets/images/extra_pulmonary_tb.jpg' )
              // child: Image.asset('assets/mask.png'),
            ),
            Container(
                child: Text('Extra Pulmonary Tuberculosis',
