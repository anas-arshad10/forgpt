...
class active_tb extends StatefulWidget {
  const active_tb({super.key});

  @override
  State<active_tb> createState() => _active_tbState();
}

class _active_tbState extends State<active_tb> {
  // @override
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('lib/assets/images/active_tb.jpg' )
              // child: Image.asset('assets/mask.png'),
            ),
            Container(
                child: Text('Active Tuberculosis',
